      ...
      {items.map((item) => (
        <div key={item.id} className="relative">
          {item.children ? (
                      ...
                      {item.children.map((subitem) => (
                        <div key={subitem.id}>
                          {subitem.children ? (
                            ...
                            <a href={subitem.url} className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                              <div className="ml-4">
                          ...
                          <ul role="list" className="mt-4 space-y-4">
                            {item.featured.map((feature, index) => (
                              <li key={index} className="truncate">
                                <a href={feature.link} className="font-medium text-gray-900 hover:text-gray-700">
                                  {feature.title}
                                </a>
                              </li>
                            ))}
            ...
            <a href={item.url} className="text-base font-medium text-gray-500 hover:text-gray-900">
              {item.label}
            </a>
          )}
        </div>
